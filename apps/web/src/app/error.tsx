...
export default function Error({
  ...
  useEffect(() => {
    console.error('AI Guardian Application Error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center space-y-4">
      ...
      <div className="space-y-1 max-w-md">
        <h2 className="text-lg font-bold text-white tracking-tight">Audit Workspace Exception Recovered</h2>
        <p className="text-xs text-slate-400 leading-relaxed">
          {error?.message || 'An operational error occurred while rendering the compliance workspace.'}
        </p>
      </div>
